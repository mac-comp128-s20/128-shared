...
public class AVLTree<E extends Comparable<E>> extends BinarySearchTree<E> {
    ...
    private AVLNode<E> rotateLeft(AVLNode<E> pivot) {
        //TODO: complete me. Remember to update the links, parents, and heightFromLeafs
        AVLNode<E> x = null; //fix me. You may need to cast a Node<E> reference to an AVLNode<E>
